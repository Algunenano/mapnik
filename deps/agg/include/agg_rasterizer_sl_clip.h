...
//                tx1 = std::min(tx1, static_cast<double>(std::numeric_limits<coord_type>::max()));
//                tx2 = std::min(tx2, static_cast<double>(std::numeric_limits<coord_type>::max()));
//                ty1 = std::min(ty1, static_cast<double>(std::numeric_limits<coord_type>::max()));
//                ty2 = std::min(ty2, static_cast<double>(std::numeric_limits<coord_type>::max()));
